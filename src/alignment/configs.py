...
@dataclass
class LargeMarginPreferenceDataArguments(DataArguments):
    margins_file: str = field(
        default=None,
        metadata={"help": "Path to reward margins file"}
    )
    top_p_margins: float = field(
        default=None,
        metadata={"help": "Top percentage largest margin samples"}
    )
